...
import { IntervalTree } from '../lib/index.js' // import IntervalTree from 'node-interval-tree'
...
search - intervalTree.search(low, high) => [ Interval, Interval, Interval ], empty array if no result
